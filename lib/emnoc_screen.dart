...
• Post-abortion Care
          ...
          """, 17),
                boldText(
                    "The  dates for 87th EMNOC workshop are  8th,9th and 10th of September 2022 Regards",
                    18),
                VSpace(20),
                CustomTextField(
                    ...
                    : PrimaryMaterialButton(context, () async {
                        ...
                        final Uri emailLaunchUri = Uri(
                            ...
                            queryParameters: {
                              ...
                              'body':
                                  """Name:${nameController.text}Email:${emailController.text}Phone:${phoneController.text}PDMC NUmber:${pmdcController.text}Hospital:${hospitalController.text}"""
                            });
